<h1>StageBear API</h1>
This is the API app that connects with <a href="https://github.com/LadyJane1114/StageBear" target="_blank">StageBear</a> to allow for integration with the front end, allowing for ticket purchasing.
